% function [features, featureMetrics, varargout] = v1BagOfFeaturesExtractor(I)
% Can tweak parameters, specify different feature extractors
% Preprocess image as required
...
imgFolder = fullfile('..', 'FoodData', 'apple');
